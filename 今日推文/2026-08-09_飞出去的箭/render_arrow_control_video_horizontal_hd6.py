...
base.W = 1920
base.H = 1080
base.ASS = ROOT / "arrow_control_bilingual_horizontal_hd.ass"
base.OUT = ROOT / "小红书_飞出去的箭_横版高清修正版.mp4"
base.DESKTOP_OUT = Path("/Users/luca/Desktop/小红书_飞出去的箭_横版高清修正版.mp4")
base.RENDER = ROOT / "render_horizontal_hd"
base.QC = ROOT / "qc_horizontal_hd"

HD_FRAMES = [
    ROOT / "frames_hd/01_archer_dawn.png",
    ROOT / "frames_hd/02_phone_anxiety.png",
    ROOT / "frames_hd/03_free_throw.png",
    ROOT / "frames_hd/04_process_detail.png",
    ROOT / "frames_hd/05_phone_down.png",
    ROOT / "frames_hd/06_sunrise_court.png",
]
...
def main() -> None:
    ...
    edges = [0.0, 13.71, 36.85, 52.24, 67.04, 82.80, duration]
    segments = [
    ...
    silent = base.RENDER / "silent_hd.mp4"
    base.run([
    ...
    manifest = {
        ...
        "format": "1920x1080 landscape, HD independent frames",
    ...
    (ROOT / "render_manifest_horizontal_hd.json").write_text(json.dumps(manifest, ensure_ascii=False, indent=2), encoding="utf-8")
